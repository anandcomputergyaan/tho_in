          ...
          <div class="main_cropper_box" style="width:80%; margin:auto;">
            <div class="col-md-12">
              ...
              <div class="img-container">
                <img id="image" src="<?php echo base_url('uploads/facility/'.$current_facility['image_icon']);?>" alt="Picture">
              </div>
            </div>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        ...
                        <form method="post" action="<?php echo base_url('admin/Facilities/cropper_store/'.$current_facility['id']); ?>">
