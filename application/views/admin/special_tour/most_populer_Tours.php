  ...
  <section class="content">
    ...
    Most Populer Tours
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Most Populer Tours</li>
      </ol>
    </section>
          ...
          <div class="col-md-9">
            <form action="../special_tour_update" method="post"  id="form_id" >
              ...
              <table class="table responsive form-group">
                <tr>
                  <td><b> Title<span class="star">*</span>:</b></td><td><input type="text" value="" name="title" required  class="form-control" placeholder=" Enter Title">
                    <span id="show"></span>
                   </td>
                </tr>
