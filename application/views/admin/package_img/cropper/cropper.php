          ...
          <div class="main_cropper_box" style="width:80%; margin:auto;">
            <div class="col-md-12">
              ...
              <div class="img-container">
               <img id="image" src="<?php echo base_url('uploads/package/'.$current_facility[$image_name]);?>" alt="Picture">
              </div>
            </div>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        <a  style="display: none;" class="btn btn-primary" id="download" href="javascript:void(0);" download="cropped.jpg">Download</a>
                         <form method="post" action="<?php echo base_url('admin/package/cropper_store/'.$current_facility['id']); ?>">
                
                <input type="hidden" id="facility_image_data" name="facility_image_data" value=""> 
                <input type="hidden" name="col_name" value="<?php echo $image_name;?>" >
