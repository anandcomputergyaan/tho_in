    ...
    <div class="panel panel-info">
      ...
      <div class="panel-body">
        ...
        <div  class="row" >
          ...
          <div class="col-md-8">
            <br>
            <form action="featured_collections/save" method="post"  id="form_id" enctype="multipart/form-data" >
          ...
          <tr> <td><b> Slider Alt* :</b></td><td> <input type="text" name="slider_alt" class="form-control" placeholder=" Enter Slider Alt Attribute" required > </td>
            ...
            <tr>
              <td><b> Destinations(route): </b></td> <td> <input type="text" name="destination" placeholder=" Enter Destinations" class="form-control" required > </td>
            </tr>


            <tr>
              <td><b> Duration : </b></td> <td> <input type="number" name="duration" placeholder=" Enter Duration" class="form-control" required > </td>
            </tr>
