...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="panel panel-info">
      <div class="panel-heading">Form <a href="<?php echo base_url("/admin/slider/featured_collections/slider_list")?>" class="pull-right" >Back</a> </div>
        ...
        <div  class="row" >
          ...
          <div class="col-md-8">
            ...
            <tr> <td><b>Slider Image* : </b></td><td> 
                    <img src="<?php echo base_url('uploads/slider/featured_collections/'.$data['slider_image']);?>" class="img img-lg">
          ...
          <tr> <td><b> Slider Alt* :</b></td><td> <input type="text" name="slider_alt" value="<?php echo $data['slider_alt'];?>"class="form-control"  required > </td>
            ...
            <tr>
              <td><b> Destinations(route) : </b></td> <td> <input type="text" name="destination" placeholder=" Enter Destinations" class="form-control" value="<?php echo $data['destination'];?>" required > </td>
            </tr>


            <tr>
              <td><b> Duration : </b></td> <td> <input type="number" name="duration" placeholder=" Enter Duration" class="form-control" value="<?php echo $data['duration'];?>" required > </td>
            </tr>
