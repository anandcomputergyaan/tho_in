          ...
          <div class="main_cropper_box" style="width:80%; margin:auto;">
            <div class="col-md-12">
              ...
              <div class="img-container">
                  <img id="image" src="<?php echo base_url('uploads/slider/main_slider/'.$data['slider_image']);?>" alt="Picture">
              </div>
            </div>
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        ...
                        <form method="post" action="<?php echo base_url('admin/slider/Main_slider/cropper_store/'.$data['id']); ?>">
