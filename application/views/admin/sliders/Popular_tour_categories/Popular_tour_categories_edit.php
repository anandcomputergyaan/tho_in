    ...
    <section class="content-header">
     ...
     Popular Tour Categories Slider
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"> Popular Tour CategoriesSlider</li>
      </ol>
    </section>
    
    <!-- /.row (main row) -->
    <div class="panel panel-info">
      <div class="panel-heading">Form <a href="<?php echo base_url("/admin/slider/Popular_tour_categories/slider_list")?>" class="pull-right" >Back</a> </div>
        ...
        <div  class="row" >
          ...
          <div class="col-md-8">
            ...
            <tr> <td><b>Slider Image* : </b></td><td> 
                    <img src="<?php echo base_url('uploads/slider/Popular_tour_categories/'.$data['slider_image']);?>" class="img img-lg">
