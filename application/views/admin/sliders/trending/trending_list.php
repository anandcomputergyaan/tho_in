  ...
  <section class="content">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Trending Slider </li>
      </ol>
    </section>
    
    <!-- /.row (main row) -->
    <div class="panel panel-info">
      <div class="panel-heading">List <a href="<?php echo base_url("/admin/slider/trending")?>" class="pull-right" >Add</a> </div>
          ...
          <div class="col-md-12">
            ...
            <table class="table table-hover table-bordered">
              ...
              foreach($data as $row) { $id = $row['id']; ?> <tr>
                ...
                <td><img src="<?php echo base_url('uploads/slider/trending/'.$row['slider_image']);?>" class="img img-lg"></td>
                ...
                <td><a href="<?php echo base_url("admin/slider/trending/slider_edit/".$row['id']);?>">
                  <button title="Edit" class="btn btn-success  btn-sm"><span class="fa fa-edit"></span></button></a>
                  <a href="<?php echo base_url("admin/slider/trending/delete/".$row['id']); ?>">
