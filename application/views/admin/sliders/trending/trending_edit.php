...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="panel panel-info">
      <div class="panel-heading">Form <a href="<?php echo base_url("/admin/slider/trending/slider_list")?>" class="pull-right" >Back</a> </div>
        ...
        <div  class="row" >
          ...
          <div class="col-md-8">
            ...
            <tr> <td><b>Slider Image* : </b></td><td> 
                    <img src="<?php echo base_url('uploads/slider/trending/'.$data['slider_image']);?>" class="img img-lg">
          ...
          <tr> <td><b> Slider Alt* :</b></td><td> <input type="text" name="slider_alt" value="<?php echo $data['slider_alt'];?>"class="form-control"  required > </td>
            ...
            <tr>
              <td><b> Destination (route): </b></td> <td> <input type="text" name="destination" placeholder=" Enter Destination" class="form-control" value="<?php echo $data['destination'];?>" required > </td>
            </tr>
